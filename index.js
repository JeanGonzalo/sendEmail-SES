...
var params = {
    Source: 'r.jahkorn@hotmail.com',
    Destination: {
        ToAddresses: [
            'rjeangonzalo@gmail.com'
        ]
    },
    ...
    Message: {
        Body: {
            Html: {
                Charset: "UTF-8",
                Data: ` Hola que tal como estas ?
                <a href="https://scontent.flim13-1.fna.fbcdn.net/v/t1.0-9/87984454_636736270499319_8331165904792453120_o.jpg?_nc_cat=108&_nc_sid=a61e81&_nc_ohc=KZ5ucwJVLvEAX_HO3xc&_nc_ht=scontent.flim13-1.fna&oh=613922d162910f622bf9679f4615317e&oe=5EB9A191"></a>
																...
																<tr>
																	<td align="left" valign="top" class="flexibleContainerBox">
																		<table border="0" cellpadding="0" cellspacing="0" width="210" style="max-width:100%;">
																			<tr>
																				<td align="left" class="textContent">
																					<img src="http://www.charlesmudy.com/respmail/respmail-medium.jpg" width="210" class="flexibleImage" style="max-width:100%;" alt="Text" title="Text" />
																				</td>
																			</tr>
																		</table>
																	</td>
...
new AWS.SES(SESConfig).sendEmail(params).promise()
    .then((res) => {
        console.log(res);
        console.log('Cenviado correctamente')
    })
    .catch((err) => {
